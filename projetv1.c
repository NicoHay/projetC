...
void*  serveur(void* arg){
    ...
    adresseDuServeur.sin_port        = htons(8888);
...
int main (int argc, char** argv){
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        printf("\n====================\ntaille du tableau %ld et l'index est a : %d\n====================\n", sizeof(zmClientBrain)/sizeof(int), monIndex);
    ...
    pthread_join (threadserveur, &retourserveur);
            printf("le retour du serveu esttttt : %ld",(long)retourserveur);
